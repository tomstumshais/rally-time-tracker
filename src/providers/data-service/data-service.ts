...
export class DataServiceProvider {
  ...
  // selected point format. Will set in time-tracker.ts
  public selectedType: String;
  // store all sent results by specific checkpoint
  public resultsHistory: Array<any> = [];
  ...
  sendData(data: any, timeout: number) {
    return this.http
      .post(this.url + "/setData.php", this.getFormUrlEncoded({ data: data }), {
        headers: new HttpHeaders({
          // necessary header to pass Form Data
